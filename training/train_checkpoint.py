...
if __name__ == "__main__":
    ...
    checkpoint_path = edict(model_args.model).pretrained_model_name_or_path
...
deepspeed --master_port=29557 training/train_checkpoint.py --config configs/sft_sft_otb100.yaml
"""